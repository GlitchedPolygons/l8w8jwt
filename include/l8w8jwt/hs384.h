 ...
 *  @file hs384.h
 *  @author Raphael Beck
 *  @brief Encode and decode Json Web Tokens using the HMACSHA384 algo.
 */

#ifndef L8W8JWT_HS384_H
#define L8W8JWT_HS384_H
...
/**
 * Creates an HS384 signed Json-Web-Token.
