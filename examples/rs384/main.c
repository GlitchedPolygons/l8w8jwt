...
static const char RSA_KEY[] = "-----BEGIN RSA PRIVATE KEY-----\n"
...
int main(void)
{
    ...
    struct l8w8jwt_encoding_params params =
    {
        ...
        .secret_key = (unsigned char*)RSA_KEY,
        .secret_key_length = strlen(RSA_KEY),
    ...
    int r = encode(&params);
    printf("\nl8w8jwt_encode_rs384 function returned %s (code %d).\n\nCreated token: \n%s\n", r == L8W8JWT_SUCCESS ? "successfully" : "", r, jwt);
